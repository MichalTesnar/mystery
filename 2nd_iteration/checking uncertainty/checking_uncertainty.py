...
SAMPLE_RATE = 10 # the rate at which we sample the interval we want to train on
...
## model definition
# def get_dropout_model(prob=0.3):
#     model = Sequential()
...
if __name__ == "__main__":
    ...
    ax.plot(current_x_train, current_y_train, '.', color=(0.9, 0, 0, 1), markersize=15)
